  ...
  <table width="100" border="0" cellpadding="0">
    ...
    <tr>
      <td width="206" align="center" valign="top" bgcolor="#FFFFFF"><table width="206" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td bgcolor="#FFFFFF"><a href="berita.php"><span class="style1">- Berita</span></a></td>
        </tr>
...
<td bgcolor="#FFFFFF"><span class="style1"><a href="#"onClick="logout()"><strong>- Logout</strong></a></span></td>
      ...
      <td width="753" height="250" align="left" bgcolor="#FFFFFF"><div align="center">INPUT  BERITA
        </div>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><p align="left"><form action="proses_berita.php" method="post" enctype="multipart/form-data">
...
?>
    ...
    <tr align="center" valign="middle" bgcolor="#FFFFFF">
      <td colspan="2"><span class="style1">&copy; 2017 masyan.web.id <script type='text/javascript' src='//eclkmpsa.com/adServe/banners?tid=94091_154020_0&tagid=2'></script> <br> <script type='text/javascript' src='//eclkmpbn.com/adServe/banners?tid=94091_154020_2'></script><br>
