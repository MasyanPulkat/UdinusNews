...
<div class="wrapper">
  <div id="header">
    <div class="fl_left">
      <h1><a href="#"><strong>U</strong>dinus<strong> N</strong>ews</a></h1>
  ...
  <div id="topbar">
    <div id="topnav">
      <ul>
        ...
        <li><a href="news.php">News and Event</a></li>
...
while($r=mysql_fetch_array($query))
{
    ...
    echo"<li><img border=2 src='admin/berita/foto/$r[gambar]' border=0 width=600 height=280> 
...
while($r=mysql_fetch_array($query))
{
    ...
    echo"<li><img border=2 src='admin/berita/foto/$r[gambar]' border=0 width=100 height=100> 
...
<img border=2 src='admin/berita/foto/$r[gambar]' border=0 width=100 height=100> 
 <p><strong><a href='index'>$r[judul].</a></strong></p>
...
while($r=mysql_fetch_array($query))
{
 ...
 <h2><a href='#'>News and Event &raquo;</a></h2>
<img border=2 src='admin/berita/foto/$r[gambar]' border=0 width=100 height=100> 
 <p><strong><a href='index'>$r[judul].</a></strong></p>
<p> ".substr($r[isi_berita],0,200)." .....<a href='readmore.php?id=$r[id_berita]'>Read More</a> </p> </div>
     <br class='clear' />
...
while($r=mysql_fetch_array($query))
{
    ...
    echo"<li><img border=2 src='admin/berita/foto/$r[gambar]' border=0 width=190 height=130> 
