...
{
    echo" <h1><strong>$r[judul]</strong></h1><br>
...
if (1 != $paging){//tanda != berarti perintah akan dijalankan jika $paging tidak sama dengan 1, copyright all teknik paging by go_blind_hacker, powered by V-boys_studio
	$back=$paging-1;
	echo "<div id='kotak-paging'><a href='students.php?paging=$back'><b>Back</b></a></div>";
	}
	else{
...
if ($paging != $jumlah_halaman){
	$next=$paging+1;
	echo" <div id='kotak-paging'><a href='students.php?paging=$next'>  <b>Next</b></a></div>";
	}
	else
	{
